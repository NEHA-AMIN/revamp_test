...
export default function IndustriesSection() {
  ...
  const INDUSTRIES: IndustryCardProps[] = [
    { title: 'Retail & Restaurants', tagline: 'Find the perfect spot for your next store and know what customers will buy.', imageSrc: '/retail.jpeg', useCases: [ { label: 'Physical Observability (stores)' }, { label: 'Market Potential' }, { label: 'Site Selection' }, { label: 'Demand Planning' }, { label: 'Promotion Recommendation' }, ], },
    { title: 'CPG', tagline: 'Choose the right retail partners and predict which products will sell best.', imageSrc: '/CPG.jpeg', useCases: [ { label: 'Market Potential' }, { label: 'Retailer Selection' }, { label: 'Demand Planning' }, { label: 'Product Recommendation' }, { label: 'Promotion Recommendation' }, ], },
    { title: 'Online to Offline', tagline: 'Optimize your delivery zones, pricing, and product mix in real time.', imageSrc: '/property.jpeg', useCases: [ { label: 'Physical Observability (zones, stores, restaurants)' }, { label: 'Demand Planning' }, { label: 'Dynamic Pricing' }, { label: 'Product Assortment' }, ], },
    { title: 'Travel', tagline: 'Create personalized travel experiences and get recommend the right trips.', imageSrc: '/travel.jpeg', useCases: [ { label: 'Physical Observability (properties)' }, { label: 'Personalized Discovery & Recommendations' }, { label: 'Dynamic Pricing & Bundling' }, ], },
  ];
