  ...
  return (
    <>
      <style jsx>{`
        .neural-grid {
          background-image:
            ...
            linear-gradient(0deg, transparent 24%, rgba(20, 184, 166, 0.03) 25%, rgba(20, 184, 166, 0.03) 26%, transparent 27%, transparent 74%, rgba(13, 148, 136, 0.03) 75%, rgba(13, 148, 136, 0.03) 76%, transparent 77%),
            linear-gradient(90deg, transparent 24%, rgba(20, 184, 166, 0.03) 25%, rgba(20, 184, 166, 0.03) 26%, transparent 27%, transparent 74%, rgba(15, 118, 110, 0.03) 75%, rgba(15, 118, 110, 0.03) 76%, transparent 77%);
        ...
        .ai-orb {
          ...
          height: 120px;
          border-radius: 50%;
          background: radial-gradient(circle at 30% 30%, rgba(20, 184, 166, 0.4), rgba(13, 148, 136, 0.2), transparent);
          filter: blur(1px);
        ...
        .ai-orb:nth-child(2) {
          width: 80px;
          height: 80px;
          background: radial-gradient(circle at 40% 40%, rgba(20, 184, 166, 0.5), rgba(15, 118, 110, 0.2), transparent);
          animation-delay: -2s;
        ...
        .ai-orb:nth-child(3) {
          width: 200px;
          height: 200px;
          background: radial-gradient(circle at 60% 20%, rgba(13, 148, 136, 0.3), rgba(20, 184, 166, 0.15), transparent);
          animation-delay: -4s;
        ...
        .energy-particle {
          ...
          width: 4px;
          height: 4px;
          background: radial-gradient(circle, #fff, #14b8a6);
          border-radius: 50%;
          pointer-events: none;
        ...
        .newsletter-input:focus {
          ...
          box-shadow: 0 0 0 4px rgba(20, 184, 166, 0.1), 0 0 20px rgba(20, 184, 166, 0.2);
      ...
      <section
        ref={sectionRef}
        id="cta-section"
        className="relative min-h-screen flex items-center justify-center bg-slate-50 dark:bg-black text-slate-900 dark:text-white overflow-hidden"
        style={{
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          >
            <motion.div
              ...
              className="mb-8"
            >
              <span className="inline-block px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-teal-500/20 to-teal-600/20 border border-teal-500/30 mb-6">
          ...
          >
            <div className="h-px bg-gradient-to-r from-transparent via-teal-500/50 to-transparent w-full max-w-2xl" />
            <div className="mx-4 p-2 rounded-full bg-gradient-to-r from-teal-500/20 to-teal-600/20 border border-teal-500/30">
